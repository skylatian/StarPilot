  ...
  def _build_panels(self):
    ...
    self._advanced_rows = [
      ...
      SettingRow(
        ...
        on_click=lambda: self._show_slider("SteerKP", max(0.01, cs.steerKp) * 0.05, max(0.01, cs.steerKp) * 1.95, step=0.01, value_type="float"),
      ...
      SettingRow(
        ...
        on_click=lambda: self._show_slider("SteerLatAccel", max(0.01, cs.latAccelFactor) * 0.05, max(0.01, cs.latAccelFactor) * 1.95, step=0.01, value_type="float"),
      ...
      SettingRow(
        ...
        on_click=lambda: self._show_slider("SteerRatio", max(0.01, cs.steerRatio) * 0.05, max(0.01, cs.steerRatio) * 1.95, step=0.01, value_type="float"),
