...
class StarPilotVariables:
  ...
  def update(self, holiday_theme="stock", started=False):
    ...
    toggle.steerKp = [[0], [self.get_value("SteerKP", cast=float, condition=advanced_lateral_tuning and is_torque_car and not is_angle_car, default=steerKp, min=steerKp * 0.05, max=steerKp * 1.95)]]
    toggle.latAccelFactor = self.get_value("SteerLatAccel", cast=float, condition=advanced_lateral_tuning, default=latAccelFactor, min=latAccelFactor * 0.05, max=latAccelFactor * 1.95)
    ...
    toggle.steerRatio = self.get_value("SteerRatio", cast=float, condition=advanced_lateral_tuning, default=steerRatio, min=steerRatio * 0.05, max=steerRatio * 1.95)
    ...
    toggle.retrofit_tune_ff_gain = self.get_value("RetrofitTuneFFGain", cast=float, default=0.0, min=0.0, max=0.5)
    toggle.retrofit_tune_ff_onset = self.get_value("RetrofitTuneFFOnset", cast=float, default=0.18, min=0.0, max=2.0)
    toggle.retrofit_tune_ff_onset_width = self.get_value("RetrofitTuneFFOnsetWidth", cast=float, default=0.08, min=0.01, max=1.0)
    toggle.retrofit_tune_ff_cutoff = self.get_value("RetrofitTuneFFCutoff", cast=float, default=1.10, min=0.1, max=3.0)
    toggle.retrofit_tune_ff_cutoff_width = self.get_value("RetrofitTuneFFCutoffWidth", cast=float, default=0.30, min=0.01, max=2.0)
    toggle.retrofit_tune_transition_speed = self.get_value("RetrofitTuneTransitionSpeed", cast=float, default=10.0, min=1.0, max=30.0)
    ...
    toggle.retrofit_tune_turn_in_threshold_reduction = self.get_value("RetrofitTuneTurnInThresholdReduction", cast=float, default=0.0, min=0.0, max=0.5)
    toggle.retrofit_tune_unwind_threshold_increase = self.get_value("RetrofitTuneUnwindThresholdIncrease", cast=float, default=0.0, min=0.0, max=1.0)
    toggle.retrofit_tune_turn_in_friction_boost = self.get_value("RetrofitTuneTurnInFrictionBoost", cast=float, default=0.0, min=0.0, max=0.5)
    toggle.retrofit_tune_unwind_friction_reduction = self.get_value("RetrofitTuneUnwindFrictionReduction", cast=float, default=0.0, min=0.0, max=1.0)
    toggle.retrofit_tune_center_taper_max = self.get_value("RetrofitTuneCenterTaperMax", cast=float, default=0.0, min=0.0, max=0.5)
    toggle.retrofit_tune_center_taper_lat = self.get_value("RetrofitTuneCenterTaperLat", cast=float, default=0.14, min=0.01, max=1.0)
    toggle.retrofit_tune_center_taper_lat_width = self.get_value("RetrofitTuneCenterTaperLatWidth", cast=float, default=0.04, min=0.01, max=0.5)
    toggle.retrofit_tune_center_taper_speed = self.get_value("RetrofitTuneCenterTaperSpeed", cast=float, default=14.0, min=1.0, max=35.0)
    toggle.retrofit_tune_center_taper_speed_width = self.get_value("RetrofitTuneCenterTaperSpeedWidth", cast=float, default=2.5, min=0.1, max=10.0)
