...
class StarPilotVariables:
  ...
  def update(self, holiday_theme="stock", started=False):
    ...
    toggle.retrofit_tune_ff_gain = self.get_value("RetrofitTuneFFGain", cast=float, default=0.04, min=0.0, max=0.5)
    ...
    toggle.retrofit_tune_turn_in_friction_boost = self.get_value("RetrofitTuneTurnInFrictionBoost", cast=float, default=0.04, min=0.0, max=0.5)
    toggle.retrofit_tune_unwind_friction_reduction = self.get_value("RetrofitTuneUnwindFrictionReduction", cast=float, default=0.30, min=0.0, max=1.0)
    toggle.retrofit_tune_center_taper_max = self.get_value("RetrofitTuneCenterTaperMax", cast=float, default=0.20, min=0.0, max=0.5)
